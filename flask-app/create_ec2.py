...
def create_ec2_instance(ami_id, instance_type, subnet_id, access_key, secret_key, region_name):
...
if __name__ == "__main__":
    ...
    # Region name where the instance will be launched
    region_name = 'us-east-1'
    # Call the function to create the EC2 instance with the specified parameters
    create_ec2_instance(ami_id, instance_type, subnet_id, access_key, secret_key, region_name)
